...
Uses the project's async engine via SQLAlchemy 2.0's run_sync bridge.
All migrations are written against postgresql+asyncpg:// URLs from settings.DATABASE_URL.
"""
